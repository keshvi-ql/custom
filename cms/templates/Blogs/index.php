            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <h4 class="card-title mb-0"><?= __('Blogs') ?></h4>
                        <?= $this->Html->link(__('New Blog'), ['action' => 'add'], ['class' => 'btn btn-primary btn-rounded']) ?>
                    </div>

                        <p class="card-description"> List of all blog entries </p>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= h($blog->title) ?></td>
                                        <td><?= h($blog->author) ?></td>
                                        <td><label class="badge badge-info"><?= h($blog->created->format('d M Y')) ?></label></td>
                                        <td><label class="badge badge-secondary"><?= h($blog->modified->format('d M Y')) ?></label></td>
                                        <td class="actions">
                                            <?= $this->Html->link(
                                                '<i class="fa fa-eye"></i>', 
                                                ['action' => 'view', $blog->id], 
