...
<head>
   ...
   <?= $this->Html->script('/vendors/bootstrap-maxlength/bootstrap-maxlength.min.js') ?>
   <?= $this->Html->script('assets/vendors/datatables.net-bs5/dataTables.bootstrap5') ?>
   <?= $this->Html->tag('link', '', ['rel' => 'stylesheet', 'href' => '/vendors/ti-icons/css/themify-icons.css']) ?>
...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
   ...
   <li class="nav-item">
      <a class="nav-link" href="<?= $this->Url->build('/products') ?>">
         <i class="icon-bag menu-icon"></i> <!-- updated -->
         <span class="menu-title">Products</span>
      </a>
   </li>

   <li class="nav-item">
      <a class="nav-link" href="<?= $this->Url->build('/blogs') ?>">
   ...
   <li class="nav-item">
      <a class="nav-link" href="<?= $this->Url->build('/posts') ?>">
