            ...
            <div class="col-lg-8 offset-lg-2 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description">Update the category details below</p>

                        <?= $this->Form->create($category) ?>
                        
                        <div class="form-group">
                            <?= $this->Form->control('name', ['label' => 'Category Name', 'class' => 'form-control']) ?>
                        </div>

                        <div class="form-group">
                            <?= $this->Form->control('description', ['label' => 'Description', 'class' => 'form-control', 'rows' => 3]) ?>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <?= $this->Form->postButton('Delete', ['action' => 'delete', $category->id], [
