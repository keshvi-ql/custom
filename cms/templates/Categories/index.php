    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
                ...
                <?= $this->Html->link(__('New Category'), ['action' => 'add'], ['class' => 'btn btn-primary btn-rounded']) ?>
            </div>

                <p class="card-description"> List of all available categories </p>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><label class="badge badge-info"><?= h($category->created->format('d M Y')) ?></label></td>
                                <td><label class="badge badge-secondary"><?= h($category->modified->format('d M Y')) ?></label></td>
                                <td class="actions">
                                    <?= $this->Html->link(
                                        '<i class="fa fa-eye"></i>',
